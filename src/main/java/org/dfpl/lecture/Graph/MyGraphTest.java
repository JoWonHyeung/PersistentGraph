...
public class MyGraphTest {
    public static void main(String[] args) throws Exception {
        ...
        PersistentGraph g1 = new PersistentGraph(id, pwd, dbName);
...
//        v1.remove();
        ...
        Edge v2v5 = g1.addEdge(v2,v5,"mad");
        Edge v2v6 = g1.addEdge(v2,v6,"m");

        System.out.println("[vertex getTwoHopVertices test]");
        System.out.println(v1_get.getTwoHopVertices(Direction.OUT));;
